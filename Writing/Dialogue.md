...
Skill choices ([[Progression]]) can be referenced in speech. When asked why I would be suited for the role by the recruiter, I could mention my high Fitness on behalf of my Fitness skill point.
	I still, however, could not mention my background as a Soldier.
		This later came up in UC SysDef. As Bethesda uses multiple quest writes, some have covered their bases for skill and background choices and others havent. [[Poor Planning]] once again, is it possible that said background [[• Gameplay Systems]] wasn't implemented at the time of some of these quests being written, and they were not retroactively upgraded?
...
Having NPCs cut off each other in dialogue is possible; the [[Tracker's Alliance]] free Hannibal quest does it. So it’s not an engine issue, but a QA issue. That’s even more egregious.
	^ Apparently, this quest has [[Starborn]] dialogue? Need to check.
