...
Todd know that it's [[• Gameplay Systems]] that create many of the memorable moments people love, so that's his focus. 
What happens when you start to remove them, when problems arise, like with Gore ([[Interviews]]). They removed them, levitations, recall etc.
