...
Makes [[travelling]] a KM+ to the next POI go from a 5-minute slog of nothing into a 30-second bit of fun.
...
![[Screenshot 2025-06-19 at 12.10.15.png]]
...
Even the bloated [[surveying|survey mechanic]] and its default of 10 scans is no longer as much of an issue when you can [[• Exploring|explore]] multiple square meters in the fraction of the time, while engaging with the speed boost, jump and general joy that ragging around this slightly advanced dune buggy brings. 
...
I theorise that it was worked on early and pushed back in the schedule to focus on more pressing matters. The only issue it has is that the player travels so fast that the stream loading of assets can struggle, even on an SSD, causing a lot of pop-in and slowdown. With a Ryzen 9 and 4080, speeding into [[Akila City]] from the wilderness saw my FPS drop to 20fps. 
