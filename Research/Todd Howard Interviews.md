...
Todd is aware of the disconnect between their questing and sandbox gameplay. [[• Gameplay Systems]]
...
The advent of the [[Creation Club integration]]
...
- [[Sundog]] - sci-fi game with 'partialist interface' (moving objects around and putting them together) where you could fly around on your own ship.
- [[Traveller TTRPG ]]- Hard sci-fi. Todd tried to program a CRPG version on the Apple II. Where he discovered that computers could run out of memory. 
- 1:35 "Can we pull off something like this with today's computers?"

1:50 Is Starfield considered [[Hard Sci Fi]]?
...
- Acknowledges that a [[Reliance on Mods|Mod]] may change that.
...
52:30 Todd acknowledges that [[Romance]] isn't complex
...
Mentions [[Traveller TTRPG]] again
"[[Starfilght]], [[Star Control 2]]"
...
59:50 [[Procedural Generation|Procedurally generated]] tiles and went in to fix any errors, then built a system that took those and wrapped them around a planet and blended them. 
...
1:00:25 "There was a big design problem to solve with what's fun with landing on a planet with potentially nothing. There's nothing on them except resources. Ok, let's lean on the lonely experience, these are the resources that are there, go find them".
	If that was the gameplay loop they focussed on, why are the gameplay systems that use these resources, [[Crafting]] and [[Outpost Management]] so gimped compared to FO4. And relegated to side activities with barely any function to any questlines.

[[Travelling]] 1:04:56 "We used to run out of fuel, you'd jump and get stranded."
...
[[Minority Report]] - "There's a lot of future stuff in that movie"

[[Progression]]  - 1:44:26 "One of the things that over times we've wanted to avoid is people starting over"
...
1:47:36 Why is it bad to break the game? [[Side Quests]]
...
[[Side Quests]] / [[Radiant Quests]] - 1:48:50 Todd understands good open ended quest design that relies on the player to answer the quest themselves, but yet we see so little of this in-game outside of the radiant missions...
...
Lots of [[• Gameplay Systems]] not working together
...
7:05 How did the game evolve over the course of 8 years [[• Development]]
...
11:50 "The more you give to Starfield, the more it gives back, and that was one of our goals"
	Sort of true in that ship building, outpost building and crafting require large time, [[Progression]] and credit investments to get the most out of them - but the journey to get there will burn out many players with the ARPG adjacent [[• Exploring]] and [[Points of Interest]] system.
...
13:32 Skyrim's success motivated the inclusion of [[NG+]] and the use of [[Procedural Generation]] to create a universe that could be played 'forever'
...
- Walking through sandstorm to near by landed ship, ambushed by crew, goes on board, ship takes off and now he's in space
		Todd was in awe of the tech, shocked that can even happen. He cares more about [[• Gameplay Systems|systems]] than quests, all of the people at the end of the direct do. 
...
25:16 Todd knows the USP as a everything game. [[• Gameplay Systems]]
...
9:08 - "That kind of feeling is what we want. Where you can look at the scope of the game and the palette of things you can do, and say what if? I'm gonna do these things."
	This is what Starfield suffers from. Possibly due to the lack of a starting point. People may start that palette by aiming in a random direction and starting to walk to see what they find. The [[Travelling]] system puts an immediate barrier to entry, especially once the player feels confident in what they will find - [[Procedural Generation]] and random [[Points of Interest]].
...
Identified problem with spawning of [[Points of Interest]], but incorrectly states that they've dialled it in well.
...
25:40 - "You can assign [[Companions]] to ships you're not using and things like that"
...
32:00 [[Ship building]] is for the late game; it costs a lot of credits and is deliberately a complicated system. You can easily upgrade the ship, but the choice to alter the ship more deeply was designed as a long-term endgame goal. (Which is how the fans interact with it as well.)
...
3:05 Why are there no [[Ground vehicles]]?
"It's something we considered. Once you do vehicles it does change the gameplay, so by focusing on foot, it let's us make it an experience where we know how fast they're seeing things."
	So the reason was to minimise repetition of [[Points of Interest]] and drag out surface gameplay, even to slow down the [[Surveying]] and to avoid pop-in...
