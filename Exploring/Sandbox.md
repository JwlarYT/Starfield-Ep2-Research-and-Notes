...
Starfield isn’t a game about [Artifacts](Main%20Quest/Artifacts.md), the [United_Colonies](Factions/United_Colonies.md), [Crimson_Fleet](Factions/Crimson_Fleet.md) or any of that. It’s a brand new space-based [Sandbox](Exploring/Sandbox.md) where modders can use the familiar user-friendly creation kit to go wild. Where gamers can customise the sandbox to become the space game of their dreams.
